...
import 'package:lms_flutter_app/Service/quiz_service.dart';
...
class QuizController extends GetxController {
  ...
  Future fetchAllQuizResults() async {
    ...
    try {
      ...
      print('📚 Fetching all quiz results for archive...');

      // Use the QuizService to get all quiz results
      var results = await QuizService.getAllQuizResults(token);

      if (results != null && results.isNotEmpty) {
        print('📚 Found ${results.length} quiz results');
      ...
      print('❌ Error fetching all quiz results: $e');
      print('❌ Stack trace: $t');
      allQuizResults.clear();
    } finally {
