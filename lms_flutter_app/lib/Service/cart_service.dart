...
class CartService {
  ...
  Future<bool> addToCart(int courseId) async {
    try {
      ...
      Uri url =
          Uri.parse('https://test.progemadphy.com/api/add-to-cart/$courseId');
  ...
  Future<bool> removeFromCart(int courseId) async {
    try {
      ...
      // Use the new API endpoint format from user's request
      Uri url = Uri.parse(
          'https://test.progemadphy.com/api/remove-to-cart/$courseId');
  ...
  Future<List<CartList>> getCartList() async {
    try {
      ...
      // Use the new API endpoint format from user's request
      Uri url = Uri.parse('https://test.progemadphy.com/api/cart-list');
  ...
  Future<Map<String, dynamic>> makeOrder({String? couponCode}) async {
    try {
      ...
      Uri url = Uri.parse('https://test.progemadphy.com/api/make-order');
